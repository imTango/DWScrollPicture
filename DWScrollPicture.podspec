#
#  Be sure to run `pod spec lint DWScrollPicture.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.screensh:ts  = "www.example.com/screenshots_1.gif", "www.example.com/screenshots_2.gif"
  ...
  s.source       = { :git => "http://EXAMPLE/DWScrollPicture.git", :tag => "#{s.version}" }
